...
/** The configuration values specific to the device-specific RTC
  * Driver implementation Since this is hardware specific the XMC
  * time values are used to eliminate unnecessary conversion     
*/
